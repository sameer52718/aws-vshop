...
import { getResellerProfile, updateResellerBank } from "../../../constant/apiRoutes";
...
const Bank = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const {data:res} = await axios.post(updateResellerBank,data, {headers:{Authorization:auth.token}})
      if (res.error === false) {
