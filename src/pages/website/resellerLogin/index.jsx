...
import { resellerDashboardRoutes, websiteRoutes } from "../../../constant/routes";
import axios from "axios";
import { resellerLogin } from "../../../constant/apiRoutes";
...
const ResellerLogin = () => {
  ...
  useEffect(() => {
    if (auth.token && auth.user && auth.userType === 3) {
      navigate(`${resellerDashboardRoutes.dashboard}/${resellerDashboardRoutes.home}`);
    }
  ...
  const onSubmit = async (data) => {
    try {
      const { data: res } = await axios.post(resellerLogin, { ...data, join: 1 });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
              ...
              <div className="input-area">
                ...
                <div className="forgot-password-area flex justify-between items-center mb-7">
                  ...
                  <Link to={websiteRoutes.resellerForgot}>
                    <a>
                ...
                <div className="signup-area flex justify-center">
                  <p className="md:text-base text-qgraytwo font-normal text-sm">
                    ...
                    <Link to={websiteRoutes.resellerSignup}>
