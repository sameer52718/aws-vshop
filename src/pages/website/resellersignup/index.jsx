...
import { resellerRegister } from "../../../constant/apiRoutes";
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (isLastStep) {
        ...
        if (res.error === false) {
          dispatch(setAuth({ token: res.token, userType: 3, user: res.data.account[0] }));
          toast.success(res.message);
          navigate(websiteRoutes.resellerOtp);
