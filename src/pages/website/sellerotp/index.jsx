...
import { sellerOtpResend, sellerVerifyOtp } from "../../../constant/apiRoutes";
import { useSelector } from "react-redux";
import { sellerDashboardRoutes } from "../../../constant/routes";
...
const SellerOtp = () => {
    ...
    const handleResendOtp = async () => {
      setSeconds(59);
      try {
        const { data } = await axios.get(sellerOtpResend, {
          headers: { Authorization: auth.token },
        });
        if (data.error === false) {
          toast.success(data.message);
