...
import { resellerOtpResend, resellerOtpVerify } from "../../../constant/apiRoutes";
import { useSelector } from "react-redux";
import { resellerDashboardRoutes } from "../../../constant/routes";
...
const ResellerOtp = () => {
    ...
    const handleResendOtp = async () => {
      setSeconds(59);
      try {
        const { data } = await axios.get(resellerOtpResend, {
          headers: { Authorization: auth.token },
        });
        if (data.error === false) {
          toast.success(data.message);
