...
const Invoice = () => {
  ...
  return (
    <div className="container my-12 flex justify-center">
      <div className="bg-white p-8 w-full lg:w-[80%] rounded-md space-y-4" ref={invoiceContainerRef} id="invoice-container">
        ...
        <div>
          <div className="space-y-1">
            <div className="border-b flex justify-between">
              ...
              <span className="text-sm font-semibold">Rs 9096</span>
            </div>
            <div className="border-b flex justify-between">
