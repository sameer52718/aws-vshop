...
import {
  ...
  updateFIlter,
  updateData,
} from "@/store/reseller/slice";

import { reseller } from "@/constant/data";
...
const Resellers = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setTimeout(() => {
      dispatch(fetchResellers({ signal, token })); // Pass the signal to the fetchProducts function
    }, 1000);
  };
  ...
  return (
    <div className="container relative mt-12 mb-24">
      <div className="grid grid-cols-1">
        <Breadcrumbs currentLink="Reseller" />
        ...
        <div className="grid lg:grid-cols-4 gap-4 lg:gap-0">
          <div className=" col-span-4 lg:col-span-1 bg-white h-max p-4 xs:py-5 lg:py-10 lg:px-6 rounded-md overflow-hidden">
            <div className="flex justify-between">
              <h6 className="text-lg">Filter Resellers</h6>
              <button
                type="button"
      ...
      {/* become a reseller button start */}
      <Link
        ...
        to="/reseller/signup"
      >
        Become a Reseller <Icon icon="uil:plus" />
      </Link>
      {/* become a reseller button end */}
    </div>
  );
};
