...
import { toggleMobileChatSidebar, setContactSearch } from "@/store/chat/slice";
const ChatPage = () => {
  const { width, breakpoints } = useWidth();
  const dispatch = useDispatch();
  const { activechat, mobileChatSidebar, contacts, searchContact } = useSelector((state) => state.chat);
