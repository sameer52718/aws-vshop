...
import { addSellerProperty } from "../../../constant/apiRoutes";
...
const AddProperty = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const { data: res } = await axios.post(addSellerProperty,body,{headers:{Authorization:token}});
      if (res.error === false) {
        toast.success(res.message)
        navigate(`/dashboard/seller/property/${res?.id}/video`);
      }else{
