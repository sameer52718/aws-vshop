...
import { categoryIcon, getSellerStreamingInfo } from "../../../constant/apiRoutes";
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 lg:col-span-6 space-y-4">
              <div className="flex flex-col text-[10px] xs:text-xs md:text-sm">
                <span className="text-xs md:text-base text-primary-600 font-medium">
                  Title
                </span>
                <span className="text-sm md:text-lg font-semibold ml-1 md:ml-2">
                  {data?.title}
                </span>
              </div>
              <div className="flex flex-col text-[10px] xs:text-xs md:text-sm">
            ...
            <div className="col-span-12 lg:col-span-6">
              <img
                className="w-full md:w-[60%] md:h-[300px] h-full"
                src={streamingVector}
                alt="streaming logo"
              />
            </div>
