...
import { BackCnicRoute, frontCnicRoute, getSellerProfile, updateSellerAttachments } from "../../../constant/apiRoutes"
    ...
    const getData = async () => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            ...
            const {data} = await axios.post(updateSellerAttachments , body , {headers:{Authorization:auth.token , "Content-Type":"multipart/form-data"}})
            if (data.error === false) {
    ...
    <div>
        <div className="input-area" data-aos="fade-up">
            ...
            {images.front && !cnicFront && (
                <img
                src={`${frontCnicRoute}/${images.front}`}
                alt=""
